    ...
    <script type="application/ld+json">
{
  ...
  "image": "http://peintrehumaniste.local/wp-content/uploads/2024/04/artiste.jpg",
  ...
  "itemListElement": [
    {
      "@type": "VisualArtwork",
      "name": "Clownerie II",
      "image": "http://peintrehumaniste.local/wp-content/uploads/2024/04/Clownerie-II-scaled.jpg",
    ...
    // Ajoutez plus d'objets VisualArtwork ici pour chaque œuvre d'art
  ]
}
</script>
	<?php wp_head(); ?>
